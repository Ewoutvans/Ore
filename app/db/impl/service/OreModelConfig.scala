...
trait OreModelConfig extends ModelService with OreDBOs {
  ...
  val ChangeRequestSchema = new ModelSchema[ChangeRequest](this, classOf[ChangeRequest], TableQuery[ChangeRequestTable])
  ...
  val ProjectSchema = new ProjectSchema(this, Users)
    ...
    .withChildren[ChangeRequest](classOf[ChangeRequest], _.projectId)
